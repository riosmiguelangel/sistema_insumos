...
function addSociete( $nom, $adresse,$logo,$ext_logo )
{
	...
	$this->Image($logo , 5 ,3, 35 , 25 , $ext_logo);
	$this->SetXY( $x1, $y1 );
...
// Etiqueta y número de factura / presupuesto
function fact_dev( $libelle, $num )
{
    $r1  = $this->w - 80;
    $r2  = $r1 + 68;
...
function addUsuario($idusuario,$time,$num_documento)
{
	...
	$this->Cell(10,4, "ENTREGO: ".$idusuario, 0, 0, "L");
	$this->SetFont( "Arial", "", 9);
	//$this->SetXY( $r1+9, $y1+7);

	$this->SetXY( $r1+12, $y1+6 );
	$this->Cell(20,11, "FICHA/DNI: ".$num_documento, 0, 0, "C");
	$this->SetXY( $r1, $y1+8 );
	//$this->Cell(30,2, $idusuario, 0, 0, "C");
	$this->SetXY( $r1, $y1+18 );
	$this->Cell(25,2, "FIRMA:", 0, 0, "C");
	//$this->MultiCell(80,4, $monto);
	//$this->MultiCell(150,4, $monto);
	//$this->SetX( $r1+29 );
...
function addRetiro($idagente,$time,$num_documento)
{
	$r1  = $this->w - 100;
	$r2  = $r1 + 90;
	$y1  = $this->h - 45;
	...
	$this->Cell(80,1, "RECIBIO: ".$idagente  );
	//$this->SetFont( "Arial", "", 8); 
	//$this->SetXY( $r1+42, $y1 );
	//$this->Cell(15,4, "FRANCS", 0, 0, "C");
	$this->SetFont( "Arial", "",9);
	$this->SetXY( $r1+12, $y1+11 );
	$this->Cell(20,1, "FICHA/DNI: ".$num_documento, 0, 0, "C");
	$this->SetXY( $r1, $y1+8 );
	//$this->Cell(30,2, $idusuario, 0, 0, "C");
	$this->SetXY( $r1, $y1+18 );
	$this->Cell(25,2, "FIRMA:", 0, 0, "C");
...
function MarcaAgua()
{
	//Pon la marca de agua
	$this->SetFont('Arial','B',70);
	$this->SetTextColor(255,192,203);
	$this->RotatedText(35,190,'Remito Anulado',45);
}
