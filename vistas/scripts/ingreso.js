...
function agregarDetalle(idarticulo,articulo,idcategoria,categoria,descripcion)
  {
  	var cantidad=1;
    var precio_compra=1;
    var precio_venta=1;
    ...
    if (idarticulo!="")
    {
    	...
    	'<td><input type="hidden" name="descripcion[]" id="descripcion[]" value="'+descripcion+'">'+descripcion+'</td>'+
